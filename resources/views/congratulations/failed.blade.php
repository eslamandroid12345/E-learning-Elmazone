    ...
    <div class="container">
        <div class="congratulation-wrapper">
            <div class="congratulation-contents center-text">
                ...
                <h4 class="congratulation-contents-title"> Failed Payment Transaction! </h4>
                <p class="congratulation-contents-para"> An error occurred during electronic payment. Please try again </p>
                <div class="btn-wrapper mt-4">
                    <a href="javascript:void(0)" class="cmn-btn btn-bg-1"> Try Again </a>
                </div>
            </div>
        </div>
    </div>
