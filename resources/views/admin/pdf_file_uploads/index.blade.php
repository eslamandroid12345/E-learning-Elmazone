    ...
    <div class="row">
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Pdf</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('pdf.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('pdf.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('pdf.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('pdf.edit',':id')}}');
        editScript();
    </script>
@endsection
