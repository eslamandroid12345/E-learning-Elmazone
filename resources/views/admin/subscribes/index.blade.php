...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('subscribe.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('subscribe.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('subscribe.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('subscribe.edit',':id')}}');
        editScript();
    </script>
@endsection
