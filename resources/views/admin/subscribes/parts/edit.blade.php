                ...
                <div class="col-md-12 mt-3">
                    ...
                    <Select name="season_id" class="form-control selectSeason select2">
                        ...
                        @foreach($seasons as $season)
                            <option value="{{ $season->id }}"  {{ $subscribe->season_id == $season->id ? 'selected' : '' }}>{{ $season->name_ar }}</option>
                        @endforeach
                    </Select>
                </div>
                <div class="col-md-12 mt-3">
                    ...
                    <Select name="term_id" class="form-control selectTerm select2">
                        ...
                        <option value="{{ $term->id }}"
                                {{ $subscribe->term_id == $term->id ? 'selected' : '' }}>
                            {{ $term->name_ar }}</option>
                        @endforeach
                    </Select>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <select class="form-control select2" name="month">
                        ...
                        @for($i = 1 ; $i <= 12 ; $i++)
                            <option value="{{$i}}" {{$subscribe->month == $i ? 'selected' : ''}}>{{$i}}</option>
                        @endfor
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <select class="form-control select2" name="free">
                        <option value="1" {{$subscribe->free == 'yes' ? 'selected' : ''}}>نعم</option>
                        <option value="0" {{$subscribe->free == 'no' ? 'selected' : ''}}>لا</option>
                    </select>
                </div>
            </div>
        </div>
