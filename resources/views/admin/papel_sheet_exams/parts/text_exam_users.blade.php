...
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tbody>
                            @foreach($papel_exam_users as $user)
                                <tr>
                                    <td>{{ ($user->user->name) }}</td>
                                    <td>
                                        <a href="{{ route('paperExamSheet', $user->user->id) }}"><button type="button" class="btn btn-pill btn-info-light" data-toggle="modal"
                                                data-target=""><i
        ...
        <!-- Create Or Edit Modal -->
            ...
            <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static"
                 tabindex="-1" role="dialog"
                 aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="example-Modal3">ورقة الطالب </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
