                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">مصدر الفيديو</th>
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'pdf_links', name: 'pdf_links'},
            {data: 'type', name: 'type'},
            {data: 'video_basic_id', name: 'video_basic_id'},
            {data: 'video_resource_id', name: 'video_resource_id'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ]
        showData('{{route('videoBasicPdf.index')}}', columns);
        // Delete Using Ajax
        destroyScript('{{route('videoBasicPdf.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('videoBasicPdf.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('videoBasicPdf.edit',':id')}}');
        editScript();
    </script>
@endsection
